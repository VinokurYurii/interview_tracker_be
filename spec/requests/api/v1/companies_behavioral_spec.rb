...
RSpec.describe 'Api::V1::Companies', type: :request do
  ...
  describe 'GET /api/companies' do
    ...
    it 'returns companies visible to all users' do
      ...
      get '/api/companies', headers: auth_headers_for(other_user)
  ...
  describe 'POST /api/companies' do
    it 'creates a company and returns it' do
      expect {
        post '/api/companies', params: { company: { name: 'Google', site_link: 'https://google.com' } },
    ...
    it 'rejects duplicate company names (case-insensitive)' do
      ...
      post '/api/companies', params: { company: { name: 'google' } }, headers: headers, as: :json
    ...
    it 'rejects blank name' do
      post '/api/companies', params: { company: { name: '' } }, headers: headers, as: :json
