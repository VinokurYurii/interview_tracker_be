...
RSpec.describe 'Api::V1::Positions', type: :request do
  ...
  describe 'POST /api/positions' do
    ...
    it 'creates a position for the current user' do
      expect {
        post '/api/positions', params: valid_params, as: :json
    ...
    it 'rejects invalid params' do
      post '/api/positions', params: { position: { title: '' } }, as: :json
  ...
  describe 'PATCH /api/positions/:id' do
    it 'updates position attributes' do
      ...
      patch "/api/positions/#{position.id}", params: { position: { title: 'Updated', status: 'offer' } }, as: :json
    ...
    it 'does not allow changing company_id on update' do
      ...
      patch "/api/positions/#{position.id}", params: { position: { company_id: other_company.id } }, as: :json
    ...
    it 'returns 403 for another user\'s position' do
      ...
      patch "/api/positions/#{other_position.id}", params: { position: { title: 'Hack' } }, as: :json
